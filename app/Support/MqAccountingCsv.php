...
class MqAccountingCsv
{
    ...
    public function compareActualsWithExpectedValues(array $actual, array $expected, bool $isFraction = false): array
    {
        ...
        foreach ($expected as $item) {
            ...
            $actualData = collect($actual)->filter(fn ($i) => $i['year'] == $year && $i['month'] == $month)->first();

            $difference[] = [
                'year' => $year,
                'month' => $month,
                'ltv_2y_amnt' => $this->getTheDifferenceRatio(Arr::get($item, 'ltv_2y_amnt', 0), Arr::get($actualData, 'ltv_2y_amnt', 0), $isFraction),
                'lim_cpa' => $this->getTheDifferenceRatio(Arr::get($item, 'lim_cpa', 0), Arr::get($actualData, 'lim_cpa', 0), $isFraction),
                'cpo_via_ad' => $this->getTheDifferenceRatio(Arr::get($item, 'cpo_via_ad', 0), Arr::get($actualData, 'cpo_via_ad', 0), $isFraction),
                'csv_usage_fee' => $this->getTheDifferenceRatio(Arr::get($item, 'csv_usage_fee', 0), Arr::get($actualData, 'csv_usage_fee', 0), $isFraction),
                'store_opening_fee' => $this->getTheDifferenceRatio(Arr::get($item, 'store_opening_fee', 0), Arr::get($actualData, 'store_opening_fee', 0), $isFraction),
                'fixed_cost' => $this->getTheDifferenceRatio(Arr::get($item, 'fixed_cost', 0), Arr::get($actualData, 'fixed_cost', 0), $isFraction),
                'mq_kpi' => [
                    'sales_amnt' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_kpi.sales_amnt', 0), Arr::get($actualData, 'mq_kpi.sales_amnt', 0), $isFraction),
                    'sales_num' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_kpi.sales_num', 0), Arr::get($actualData, 'mq_kpi.sales_num', 0), $isFraction),
                    'access_num' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_kpi.access_num', 0), Arr::get($actualData, 'mq_kpi.access_num', 0), $isFraction),
                    'conversion_rate' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_kpi.conversion_rate', 0), Arr::get($actualData, 'mq_kpi.conversion_rate', 0), $isFraction),
                    'sales_amnt_per_user' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_kpi.sales_amnt_per_user', 0), Arr::get($actualData, 'mq_kpi.sales_amnt_per_user', 0), $isFraction),
                ],
                'mq_access_num' => [
                    'access_flow_sum' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_access_num.access_flow_sum', 0), Arr::get($actualData, 'mq_access_num.access_flow_sum', 0), $isFraction),
                    'search_flow_num' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_access_num.search_flow_num', 0), Arr::get($actualData, 'mq_access_num.search_flow_num', 0), $isFraction),
                    'ranking_flow_num' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_access_num.ranking_flow_num', 0), Arr::get($actualData, 'mq_access_num.ranking_flow_num', 0), $isFraction),
                    'instagram_flow_num' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_access_num.instagram_flow_num', 0), Arr::get($actualData, 'mq_access_num.instagram_flow_num', 0), $isFraction),
                    'google_flow_num' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_access_num.google_flow_num', 0), Arr::get($actualData, 'mq_access_num.google_flow_num', 0), $isFraction),
                    'cpc_num' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_access_num.cpc_num', 0), Arr::get($actualData, 'mq_access_num.cpc_num', 0), $isFraction),
                    'display_num' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_access_num.display_num', 0), Arr::get($actualData, 'mq_access_num.display_num', 0), $isFraction),
                ],
                'mq_ad_sales_amnt' => [
                    'sales_amnt_via_ad' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_ad_sales_amnt.sales_amnt_via_ad', 0), Arr::get($actualData, 'mq_ad_sales_amnt.sales_amnt_via_ad', 0), $isFraction),
                    'sales_amnt_seasonal' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_ad_sales_amnt.sales_amnt_seasonal', 0), Arr::get($actualData, 'mq_ad_sales_amnt.sales_amnt_seasonal', 0), $isFraction),
                    'sales_amnt_event' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_ad_sales_amnt.sales_amnt_event', 0), Arr::get($actualData, 'mq_ad_sales_amnt.sales_amnt_event', 0), $isFraction),
                    'tda_access_num' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_ad_sales_amnt.tda_access_num', 0), Arr::get($actualData, 'mq_ad_sales_amnt.tda_access_num', 0), $isFraction),
                    'tda_v_sales_amnt' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_ad_sales_amnt.tda_v_sales_amnt', 0), Arr::get($actualData, 'mq_ad_sales_amnt.tda_v_sales_amnt', 0), $isFraction),
                    'tda_v_roas' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_ad_sales_amnt.tda_v_roas', 0), Arr::get($actualData, 'mq_ad_sales_amnt.tda_v_roas', 0, $isFraction)),
                ],
                'mq_user_trends' => [
                    'new_sales_amnt' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_user_trends.new_sales_amnt', 0), Arr::get($actualData, 'mq_user_trends.new_sales_amnt', 0), $isFraction),
                    'new_sales_num' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_user_trends.new_sales_num', 0), Arr::get($actualData, 'mq_user_trends.new_sales_num', 0), $isFraction),
                    'new_price_per_user' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_user_trends.new_price_per_user', 0), Arr::get($actualData, 'mq_user_trends.new_price_per_user', 0), $isFraction),
                    're_sales_amnt' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_user_trends.re_sales_amnt', 0), Arr::get($actualData, 'mq_user_trends.re_sales_amnt', 0), $isFraction),
                    're_sales_num' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_user_trends.re_sales_num', 0), Arr::get($actualData, 'mq_user_trends.re_sales_num', 0), $isFraction),
                    're_price_per_user' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_user_trends.re_price_per_user', 0), Arr::get($actualData, 'mq_user_trends.re_price_per_user', 0), $isFraction),
                ],
                'mq_cost' => [
                    'coupon_points_cost' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.coupon_points_cost', 0), Arr::get($actualData, 'mq_cost.coupon_points_cost', 0), $isFraction),
                    'coupon_points_cost_rate' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.coupon_points_cost_rate', 0), Arr::get($actualData, 'mq_cost.coupon_points_cost_rate', 0), $isFraction),
                    'ad_cost' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.ad_cost', 0), Arr::get($actualData, 'mq_cost.ad_cost', 0), $isFraction),
                    'ad_cpc_cost' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.ad_cpc_cost', 0), Arr::get($actualData, 'mq_cost.ad_cpc_cost', 0), $isFraction),
                    'ad_season_cost' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.ad_season_cost', 0), Arr::get($actualData, 'mq_cost.ad_season_cost', 0), $isFraction),
                    'ad_event_cost' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.ad_event_cost', 0), Arr::get($actualData, 'mq_cost.ad_event_cost', 0), $isFraction),
                    'ad_tda_cost' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.ad_tda_cost', 0), Arr::get($actualData, 'mq_cost.ad_tda_cost', 0), $isFraction),
                    'ad_cost_rate' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.ad_cost_rate', 0), Arr::get($actualData, 'mq_cost.ad_cost_rate', 0), $isFraction),
                    'cost_price' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.cost_price', 0), Arr::get($actualData, 'mq_cost.cost_price', 0), $isFraction),
                    'cost_price_rate' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.cost_price_rate', 0), Arr::get($actualData, 'mq_cost.cost_price_rate', 0), $isFraction),
                    'postage' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.postage', 0), Arr::get($actualData, 'mq_cost.postage', 0), $isFraction),
                    'postage_rate' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.postage_rate', 0), Arr::get($actualData, 'mq_cost.postage_rate', 0), $isFraction),
                    'commision' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.commision', 0), Arr::get($actualData, 'mq_cost.commision', 0), $isFraction),
                    'commision_rate' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.commision_rate', 0), Arr::get($actualData, 'mq_cost.commision_rate', 0), $isFraction),
                    'variable_cost_sum' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.variable_cost_sum', 0), Arr::get($actualData, 'mq_cost.variable_cost_sum', 0), $isFraction),
                    'gross_profit' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.gross_profit', 0), Arr::get($actualData, 'mq_cost.gross_profit', 0), $isFraction),
                    'gross_profit_rate' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.gross_profit_rate', 0), Arr::get($actualData, 'mq_cost.gross_profit_rate', 0), $isFraction),
                    'management_agency_fee' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.management_agency_fee', 0), Arr::get($actualData, 'mq_cost.management_agency_fee', 0), $isFraction),
                    'reserve1' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.reserve1', 0), Arr::get($actualData, 'mq_cost.reserve1', 0), $isFraction),
                    'reserve2' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.reserve2', 0), Arr::get($actualData, 'mq_cost.reserve2', 0), $isFraction),
                    'management_agency_fee_rate' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.management_agency_fee_rate', 0), Arr::get($actualData, 'mq_cost.management_agency_fee_rate', 0), $isFraction),
                    'cost_sum' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.cost_sum', 0), Arr::get($actualData, 'mq_cost.cost_sum', 0), $isFraction),
                    'profit' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.profit', 0), Arr::get($actualData, 'mq_cost.profit', 0), $isFraction),
                    'sum_profit' => $this->getTheDifferenceRatio(Arr::get($item, 'mq_cost.sum_profit', 0), Arr::get($actualData, 'mq_cost.sum_profit', 0, $isFraction)),
                ],
            ];
        }
